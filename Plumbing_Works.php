...
if(isset($_REQUEST["save"]))
{
    ...
    if(!empty($email))     
    {
       ...
       $sql="INSERT INTO `plumbing`(`name`, `ph_no`, `email`, `company`,  `message`)  VALUES('$name','$ph_no','$email', '$company','$message')";
...
<!--table tag start-->
<div>
    <table width="100%" height="70" bgcolor="gold" cellpadding="0" cellspacing="" border="0">
        <tr>
            <td width="18%">
                        ...
                        <tr>
                            <td>
                                <table table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td width="33%"><img src="images/plumbing%20works.jpg" alt=""></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p>Plumbing Services as an integral part of all modern day households. Plumbing brings in water into a home, providing convenience and also it serves as drainage and takes waste away from the home. Plumbing work is typically regulated by government agencies and is vital that it functions properly to optimize health and safety. Dishwashers, bathtubs, sinks and showers all rely on proper plumbing Services. A faulty drain line or a leaky faucet may seem like minor problems on the surface, but if either is not fixed correctly, the problem will become larger and more dangerous. Repairing a leaking faucet or shower head, a clogged garbage disposal, a dishwasher that will not drain, or water heater that is not heating are the focus of plumbing projects. Any plumbing installation or repair should be done thoroughly to help insure that future problems will not occur.Plumbing Services are often a result of old pipes and techniques. MHPT Plumbing Services provides services for any plumbing problem and can identify and fix future problems improper </p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr>
                                        <td width="25%">
                                            ...
                                            <select name="pdt_id" class="form-control" style="width:453px" ;>
                                                  <option value="6">Plumbing Service</option>
                                                  <option value="7">Plumbing Repair</option>
